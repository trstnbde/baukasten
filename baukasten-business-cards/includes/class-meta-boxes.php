...
final class Meta_Boxes {
	...
	private static function boxes(): array {
		return array(
			...
			'links'     => array(
				...
				'note'     => __( 'These appear in the same section as the networks above, under "My links".', 'baukasten-business-cards' ),
				'context'  => 'normal',
				'priority' => 'default',
			),
			'downloads' => array(
	...
	private static function notes(): array {
		return array(
			...
			'phone_work'           => __( 'The first number filled in below, in this order, becomes the Call button at the top of the card.', 'baukasten-business-cards' ),
			'mobile_work'          => __( 'The first mobile number becomes the WhatsApp button — WhatsApp needs a mobile number.', 'baukasten-business-cards' ),
			'email_work'           => __( 'The first address filled in below becomes the Email button.', 'baukasten-business-cards' ),
